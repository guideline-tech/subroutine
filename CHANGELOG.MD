...
Association fields now use `find_by()` instead of `find_by!()`, placing the responsibility on the op to manage nil cases rather than handling RecordNotFound errors.
